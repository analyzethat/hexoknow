...
//svg.getBoundingClientRect().width=document.window.width;
var ratio = viewBox.width / svg.getBoundingClientRect().width * 2;
window.addEventListener('resize', function () {
    ratio = viewBox.width / svg.getBoundingClientRect().width * 2;
});